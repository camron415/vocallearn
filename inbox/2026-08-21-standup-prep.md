# Standup prep
**Date:** 2026-08-21T12:00:56.215Z · **Project:** vocallearn
**Analyst job:** aj-1787313635895-9cq3j0

# Standup prep — Halo / VocalLearn
**Date:** 2026-08-21T12:00:56.215Z · **Manager:** Sloane
...
- Hardcoded Supabase test credentials removed from the dev script.

## Roadmap position
- We're on the Halo UI streamline track with Cove as the live shipping surface.
- Next real outcome is a 30-minute device smoke-test of the Ask→Practice loop once the fresh IPA is installed.

## Proposed today (P / S)
1. Approve committing the 35-file working tree so the live Halo site is protected in git — P0
2. Decide whether the next native build should target the Ask→Practice loop or continue Halo H3 motion polish — P1
3. Schedule a 30-minute device test of the Ask→Practice loop once the fresh IPA is installed — P2

## Decisions for Camron
Should we commit the 35-file working tree today to protect the live site, or hold off?
...
app/(tabs)/_layout.tsx                 |   6 +-
 ...
 web/src/components/MotionProvider.tsx  |  86 +++-
 web/src/components/PreviewSwitcher.tsx | 121 ++++-
 web/src/components/SettingsMenu.tsx    |  16 +-
 web/src/components/WaterCapsule.tsx    |  23 +-
 ...
 44 files changed, 2197 insertions(+), 710 deletions(-)
